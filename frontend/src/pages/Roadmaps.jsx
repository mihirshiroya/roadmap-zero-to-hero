  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 bg-background min-h-screen">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-2xl font-semibold text-primary">Roadmaps</h1>
        <div className="flex gap-2 border border-color rounded-lg p-1 bg-surface">
          <button
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {filteredRoadmaps.map((roadmap) => (
          <Link 
            ...
            className="block"
          >
            <Card className="hover:border-primary transition-colors bg-surface dark:bg-surface/80 border-color">
              <CardHeader>
